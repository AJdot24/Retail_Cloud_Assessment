...
--
--   Aarav Sharma (CEO, top-level employee, no reporting manager)
--   ├── Priya Nair     (Engineering Manager, head of Engineering)
--   │   └── 7 engineers
--   ├── Rohan Mehta    (Sales Manager, head of Sales)
--   │   └── 7 sales people
...
ALTER TABLE employee ALTER COLUMN id RESTART WITH 26;
